(() => {
  ...
  class FiretracePlanViewer {
    constructor(svg, {gridToggle = null, onSelect = null, showSpaces = true, showObjects = false} = {}) {
      ...
      this.showSpaces=showSpaces;this.showObjects=showObjects;this.spaces=[];this.objects=[];this.rows = []; this.selectedId = null; this.selectionPoint = null; this.viewBox = null; this.defaultViewBox = null;
      this._drag = null;
    ...
    setPlan(spaces, objects = [], selectedId = null, selectionPoint = null) { this.spaces=spaces||[];this.objects=objects||[];this.rows=[...(this.showSpaces?this.spaces:[]),...(this.showObjects?this.objects:[])];this.selectedId=selectedId;this.selectionPoint=selectionPoint;this.fit("storey"); }
